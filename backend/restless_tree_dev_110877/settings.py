"""
Django settings for restless_tree_dev_110877 project.
...
ROOT_URLCONF = 'restless_tree_dev_110877.urls'
...
WSGI_APPLICATION = 'restless_tree_dev_110877.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "restless_tree_dev_110877 API",
    "DESCRIPTION": "API documentation for restless_tree_dev_110877 App",
    "VERSION": "v1",
}
